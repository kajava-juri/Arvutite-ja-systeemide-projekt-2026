...
| Transceiver                                                                | Duplex      | Module | Vendor    | Link                                                                                                                                             |
| -------------------------------------------------------------------------- | ----------- | ------ | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [MAX485](https://www.analog.com/en/products/max485.html)                   | half-duplex | USB    | satkit    | [link](https://satkit.ee/usb-rs485-muundur-plc-jaoks-max485?search=USB-RS485%20muundur%20PLC%20jaoks%20Max485&category_id=0)                     |
| [MAX485](https://www.analog.com/en/products/max485.html)                   | half-duplex | USB    | oomipood  | [link](https://www.oomipood.ee/en/product/oky3406_6_usb_rs485_uleminek_kuni_6mbps_1200m?ref=product_also_bought)                                 |
